...
public class Run : StateMachineBehaviour
{
    ...
    {
        float distance = Vector3.Distance(playerTransform.position, blueKnight.transform.position);
        ...
        if (distance > blueKnight.basicAttackRange)
        {
          blueKnight.RunTowardsPlayer(true);
        } else
        {
